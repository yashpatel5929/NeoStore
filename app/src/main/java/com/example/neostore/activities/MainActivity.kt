...
import com.example.neostore.ViewModel.MainViewModel
...
class MainActivity : AppCompatActivity() {
    ...
    private fun userLogin() {
        ...
        viewmodel.getLoginCredential(emailAdd , loginPassword)

        viewmodel.ResponseLiveData.observe(this,{
            if(it.status == 200){
                Toast.makeText(this@MainActivity , "${it.user_msg}",Toast.LENGTH_LONG).show()
