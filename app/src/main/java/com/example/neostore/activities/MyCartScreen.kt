...
import com.example.neostore.adapter.CartListAdapter
import com.example.neostore.api.RetrofitClient
import com.example.neostore.models.CartData
import com.example.neostore.models.CartDeleteResponse
import com.example.neostore.models.CartEditResponse
import com.example.neostore.models.CartListResponse
        ...
        RetrofitClient.getClient.cartList(accessToken).enqueue(object : Callback<CartListResponse?> {
            override fun onResponse(
                ...
                if(response.body()?.data!=null){
                    ...
                    val cost = RupeeConvertorHelperClass().convertorfunction(response.body()!!.total)
                    price.text = cost
